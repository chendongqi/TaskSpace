...
backup() {
    echo "Creating backup of A计划 data..."
    ...
    BACKUP_FILE="$BACKUP_DIR/A计划_backup_$TIMESTAMP.tar.gz"
...
case "$1" in
    ...
    *)
        ...
        echo "Examples:"
        echo "  $0 backup"
        echo "  $0 restore backups/A计划_backup_20241228_143022.tar.gz"

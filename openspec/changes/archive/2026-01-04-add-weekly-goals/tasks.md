...
## 6. 样式和主题
- [x] 6.1 确保周目标组件样式与现有主题系统兼容
- [x] 6.2 测试深色/浅色模式切换
- [x] 6.3 测试 4 种主题下的显示效果
- [x] 6.4 确保响应式设计（移动端和桌面端）
- [x] 6.5 添加周目标与季度目标的视觉区分

## 7. 测试和验证
- [x] 7.1 测试周目标的创建、编辑、删除流程
- [x] 7.2 测试进度更新和可视化
- [x] 7.3 测试季度目标关联和权重设置
- [x] 7.4 测试自动进度计算（单个周目标、多个周目标、权重归一化）
- [x] 7.5 测试权重总和超过或不足 100% 的情况
- [x] 7.6 测试删除周目标后季度目标进度更新
- [x] 7.7 测试级联更新（周目标更新 → 季度目标更新 → 年度目标更新）
- [x] 7.8 测试数据持久化（刷新页面后数据保留）
- [x] 7.9 测试服务器备份和恢复（隐身模式、新设备）
- [x] 7.10 测试数据导出和导入功能
- [x] 7.11 测试键盘快捷键
- [x] 7.12 测试周数筛选和年份/季度切换功能
- [x] 7.13 测试标签系统集成
- [x] 7.14 测试季度目标手动模式和自动模式的切换

## 8. 文档更新
- [x] 8.1 更新 README.md 添加周目标功能说明
- [x] 8.2 更新 DATA_MANAGEMENT.md 添加 weeklyGoals 数据说明
- [x] 8.3 更新 CLAUDE.md 添加周目标数据结构说明
- [x] 8.4 添加季度目标和周目标关联关系的说明
- [x] 8.5 添加自动进度计算机制的说明（包括级联更新）
